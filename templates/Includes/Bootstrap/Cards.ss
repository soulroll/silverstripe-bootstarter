    ...
    <div class="card text-center mb-4">
      <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" id="cardsTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="one-tab" href="#one" data-toggle="tab" role="tab" aria-controls="one" aria-expanded="true">One</a>
          </li>
          <li class="nav-item">
