...
<div id="navigation-wrapper" class="navigation-wrapper <% if $SiteConfig.SiteNavigation == Left %>navigation-left<% else_if $SiteConfig.SiteNavigation == Justified %>navigation-justified <% else_if $SiteConfig.SiteNavigation == Megamenu %>navigation-megamenu <% else %>navigation-left<% end_if %> d-print-none">
